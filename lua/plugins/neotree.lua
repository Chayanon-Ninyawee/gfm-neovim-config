return {
    ...
    },
    {
        ...
        config = function()
            -- Not useful since it only work for the files that are opened
            ...
            require("neo-tree").setup({
                ...
                default_component_configs = {
                    ...
                    file_size = {
                        ...
                        required_width = 56, -- min width of window required to show this column
                    },
                    type = {
                        enabled = true,
                    ...
                    last_modified = {
                        ...
                        required_width = 76, -- min width of window required to show this column
                        format = "%d/%m/%Y %H:%M",
                    },
                    created = {
                        enabled = true,
